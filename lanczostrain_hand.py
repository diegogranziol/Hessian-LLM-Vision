...
checkpoint_dir = f"./checkpoints/bs={args.batch_size}_subsample={args.subsample}_lr={args.lr}_momentum={args.momentum}_optim={args.optimiser}_epochs={args.num_epochs}"
