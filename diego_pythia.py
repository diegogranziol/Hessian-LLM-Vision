...
def save_checkpoint(matrix, data_seed, vector_seed, checkpoint_dir="70mpythia"):
    os.makedirs(f"{checkpoint_dir}/diego_data_seed={data_seed}_vector_seed={vector_seed}", exist_ok=True)
    filename = f"{checkpoint_dir}/diego_data_seed={data_seed}_vector_seed={vector_seed}/ckpt.pt"
