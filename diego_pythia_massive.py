...
# Load dataset
tokenizer = AutoTokenizer.from_pretrained("./offline/pythia14/", local_files_only=True)
model = AutoModelForCausalLM.from_pretrained("./offline/pythia14/", local_files_only=True)
...
# Save checkpoint
def save_checkpoint(matrix, data_seed, vector_seed, checkpoint_dir="1400mpythia"):
