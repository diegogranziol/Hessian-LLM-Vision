...
class CurvVecProduct(object):
    def __init__(self, input_ids, model, device, init_vec=None):
...
checkpoint_dir = f"./checkpoints/bs={args.batch_size}_subsample={args.subsample}_lr={args.lr}_momentum={args.momentum}_optim=lanzos+{args.optimiser}_epochs={args.num_epochs}"
